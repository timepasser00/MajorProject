...
const LabTech = () => {
  ...
  const handleNavigation = (pId) => {
    ...
    navigate('/labTech/genrateReport',{state:{pId:pId, labTechWalletAddress:walletAddress}})
    console.log(pId, "Pid");
  };

  const handleReportPage = (pId) => {
    console.log("handleReportPage");
    navigate('/labTech/report',{state:{pId:pId, labTechWalletAddress:walletAddress}})
    console.log(pId, "Pid");
  };
